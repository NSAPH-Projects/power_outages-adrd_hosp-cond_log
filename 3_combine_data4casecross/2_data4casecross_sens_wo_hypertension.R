...
# case control days
case_control_2017 <- read_fst(paste0(path_data, "/data_process/case_cntrl_days/cntrl_days_zcta_2017_wo_hypertension.fst"))
case_control_2018 <- read_fst(paste0(path_data, "/data_process/case_cntrl_days/cntrl_days_zcta_2018_wo_hypertension.fst"))
...
# write data --------------------------------------------------------------
write_csv(data4casecross_ind, paste0(path_data, "data_process/data4casecross/data4casecross_ind_wo_hypertension.csv"))
