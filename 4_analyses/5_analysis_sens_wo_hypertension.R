...
# Author: Vivian  
# Date: 6/28/24
# Goal: Run analysis - sensitivity without hypertension
# spatial scale: zcta
...
# Set AIC -----------------------------------------------------------------
lowest_aic <- read_csv(paste0(path_results, "lowest_aic_wo_hypertension.csv"))
lowest_aic
...
write_csv(main_results, paste0(path_results, "main_results_wo_hypertension.csv"))
