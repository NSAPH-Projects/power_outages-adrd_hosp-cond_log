...
# Author: Vivian  
# Date: 6/28/24
# Goal: generate visualization of main results but without hypertension as an outcome (figure 2 but without hypertension outcome)
####**********************
...
main_results <- read_csv(paste0(path_results, "main_results_wo_hypertension.csv")) %>% 
  filter(r_lag == "lag1") %>% 
...
ggsave(plot = p,
       "/n/dominici_nsaph_l3/Lab/projects/power_outages-adrd_hosp-cond_log/figures/zz_extra_figure_wo_hypertension.png",
       dpi=300,
