...
# Author: Vivian  
# Date: 1/17/24
# Goal: generate visualization for sfigure 2
...
# Data wrangling ----------------------------------------------------------
# read in results, filtering to lag 0
...
ggsave(plot = p,
       "/n/dominici_nsaph_l3/Lab/projects/power_outages-adrd_hosp-cond_log/figures/sfig2_lag0.png",
       dpi=300,
       height=10, width=15, units="in")
